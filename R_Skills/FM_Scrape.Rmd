...
Mike directed me to a Foreign Ministry site of analytical interest. 

* [Iran]("http://en.mfa.ir/index.aspx?fkeyid=&siteid=3&pageid=1997")
* [Russia]("http://www.mid.ru/brp_4.nsf/main_eng") - [Twitter]("https://twitter.com/governmentrf")

I will try to scrape one of these.
```{r}
require(rvest)
require(lubridate)
#Russia
raw.data <- html("http://www.mid.ru/brp_4.nsf/main_eng")
titles <- html_nodes(raw.data,"td+ td > a") %>% html_text
date <- html_nodes(raw.data,"#toph1 td:nth-child(1) font") %>% html_text #%>% as.Date
```
